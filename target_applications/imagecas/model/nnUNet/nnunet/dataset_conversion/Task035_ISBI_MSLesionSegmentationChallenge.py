...
if __name__ == "__main__":
    ...
    dirs = [
        "/media/fabian/My"
        " Book/MedicalDecathlon/Task035_ISBILesionSegmentation/imagesTr",
        "/media/fabian/My"
        " Book/MedicalDecathlon/Task035_ISBILesionSegmentation/imagesTs",
        "/media/fabian/My"
        " Book/MedicalDecathlon/Task035_ISBILesionSegmentation/labelsTr",
    ]
    ...
    case_identifiers = np.unique(
        [
            ...
            for i in subfiles(
                "/media/fabian/My"
                " Book/MedicalDecathlon/MedicalDecathlon_raw_splitted/Task035_ISBILesionSegmentation/imagesTr",
                suffix=".nii.gz",
                join=False,
            )
        ]
