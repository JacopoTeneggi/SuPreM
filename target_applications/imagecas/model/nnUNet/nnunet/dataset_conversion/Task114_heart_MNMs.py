...
def split_4d_nii(nii_path, split_folder, pat_name=None, add_zeros=False):
    ...
    for ts, temp_file in enumerate(file_list):
        ...
        os.rename(
            os.path.join(temp_location, temp_file),
...
if __name__ == "__main__":
    ...
    train_dir = "/media/full/97d8d6e1-1aa1-4761-9dd1-fc6a62cf6264/nnUnet_raw/nnUNet_raw_data/{}/imagesTr".format(
        task_name
    )
    test_dir = "/media/full/97d8d6e1-1aa1-4761-9dd1-fc6a62cf6264/nnUnet_raw/nnUNet_raw_data/{}/imagesTs".format(
        task_name
    )
    ...
    out_dir = "/media/full/97d8d6e1-1aa1-4761-9dd1-fc6a62cf6264/nnUnet_raw/nnUNet_raw_data/{}/".format(
        task_name
    )
    ...
    json_dict["reference"] = (
        "Campello, Víctor M. et al.: Multi-Centre, Multi-Vendor & Multi-Disease Cardiac"
        " Image Segmentation. In preparation."
    )
    ...
    split_file_path = "/media/full/97d8d6e1-1aa1-4761-9dd1-fc6a62cf6264/output_nnUNet/preprocessed_data/{}/".format(
        task_name
    )
