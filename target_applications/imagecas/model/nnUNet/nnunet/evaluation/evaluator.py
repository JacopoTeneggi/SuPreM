...
class Evaluator:
    ...
    def set_labels(self, labels):
        ...
        if isinstance(labels, dict):
            ...
            raise TypeError(
                "Can only handle dict, list, tuple, set & numpy array, but input is of"
                " type {}".format(type(labels))
            )
    ...
    def set_metrics(self, metrics):
        ...
        if isinstance(metrics, set):
            ...
            raise TypeError(
                "Can only handle list, tuple, set & numpy array, but input is of"
                " type {}".format(type(metrics))
            )
...
def nnunet_evaluate_folder():
    ...
    parser = argparse.ArgumentParser(
        "Evaluates the segmentations located in the folder pred. Output of this script"
    ...
    parser.add_argument(
        ...
        type=str,
        help=(
            "Folder containing the predicted segmentations in nifti "
    ...
    parser.add_argument(
        ...
        required=True,
        help=(
            "List of label IDs (integer values) that should "
