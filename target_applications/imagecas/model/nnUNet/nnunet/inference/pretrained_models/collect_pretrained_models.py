...
def export_pretrained_model(
    ...
    for m in models:
        ...
        if not isfile(join(expected_output_folder, "postprocessing.json")):
            if strict:
                raise RuntimeError(
                    "postprocessing.json missing. Run nnUNet_determine_postprocessing"
                    " or disable strict"
                )
            else:
...
def export_entry_point():
    ...
    parser.add_argument(
        ...
        nargs="+",
        help=(
            "list of model configurations. Default: 2d 3d_lowres 3d_fullres"
            " 3d_cascade_fullres. Must be adapted to fit the available models of a task"
        ),
    ...
    parser.add_argument(
        "-tr",
        type=str,
        help="trainer class used for 2d 3d_lowres and 3d_fullres. Default: %s"
        % default_trainer,
        required=False,
    ...
    parser.add_argument(
        "-trc",
        type=str,
        help="trainer class used for 3d_cascade_fullres. Default: %s"
        % default_cascade_trainer,
        required=False,
