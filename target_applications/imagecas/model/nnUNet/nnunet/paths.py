...
if base is not None:
    ...
    print(
        "nnUNet_raw_data_base is not defined and nnU-Net can only be used on data for"
        " which preprocessed files are already present on your system. nnU-Net cannot"
        " be used for experiment planning and preprocessing like this. If this is not"
        " intended, please read nnunet/paths.md for information on how to set this up"
        " properly."
    )
...
if preprocessing_output_dir is not None:
    ...
    print(
        "nnUNet_preprocessed is not defined and nnU-Net can not be used for"
        " preprocessing or training. If this is not intended, please read"
        " nnunet/pathy.md for information on how to set this up."
    )
...
if network_training_output_dir_base is not None:
    ...
    print(
        ...
        " inference. If this is not intended behavior, please read nnunet/paths.md for"
