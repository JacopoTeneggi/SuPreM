...
from nnunet.paths import nnUNet_cropped_data, nnUNet_raw_data, preprocessing_output_dir
...
def split_4d(
    ...
    assert (
        ...
        "The input folder must be a valid Task folder from the Medical Segmentation"
        " Decathlon with at least the imagesTr and labelsTr subfolders and the"
        " dataset.json file"
    )
