...
def main():
    ...
    parser.add_argument(
        "-i",
        help=(
            "Input folder. Must point to a TaskXX_TASKNAME folder as downloaded from"
            " the MSD website"
        ),
        required=True,
    )
    ...
    parser.add_argument(
        ...
        type=int,
        help=(
            "If specified, this will overwrite the task id in the output folder. If"
            " unspecified, the task id of the input folder will be used."
        ),
    )
