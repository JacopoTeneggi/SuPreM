...
from nnunet.preprocessing.cropping import ImageCropper, get_case_identifier_from_npz
...
class Preprocessor3DBetterResampling(GenericPreprocessor):
    ...
    def resample_and_normalize(
        ...
        if force_separate_z is not False:
            print(
                "WARNING: Preprocessor3DBetterResampling always uses"
                " force_separate_z=False. You specified %s. Your choice is overwritten"
                % str(force_separate_z)
            )
            force_separate_z = False
