...
def predict_cases(
    ...
    for preprocessed in preprocessing:
        ...
        print(
            ...
            "Case:",
            output_filename,
            "Inference time: {:.2f} seconds".format(end_time - start_time),
        )
    ...
    if isfile(pp_file):
        ...
        print(
            "WARNING! Cannot run postprocessing because the postprocessing file is"
            " missing. Make sure to run consolidate_folds in the output folder of the"
...
def check_input_folder_and_return_caseIDs(input_folder, expected_num_modalities):
    ...
    print(
        "If they don't look right, make sure to double check your filenames. They must"
        " end with _0000.nii.gz etc"
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--input_folder",
        help=(
            "Must contain all modalities for each patient in the correct"
    ...
    parser.add_argument(
        ...
        "--model_output_folder",
        help=(
            "model output folder. Will automatically discover the folds "
            "that were "
    ...
    parser.add_argument(
        ...
        default="None",
        help=(
            "folds to use for prediction. Default is None "
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "use this if you want to ensemble"
    ...
    parser.add_argument(
        ...
        default="None",
        help=(
            "if model is the highres stage of the cascade then you need to use -l to"
            " specify where the segmentations of the corresponding lowres unet are."
            " Here they are required to do a prediction"
        ),
    )
    parser.add_argument(
        "--part_id",
        ...
        default=0,
        help=(
            "Used to parallelize the prediction of "
    ...
    parser.add_argument(
        ...
        type=int,
        help=(
            "Determines many background processes will be used for data preprocessing."
    ...
    parser.add_argument(
        ...
        type=int,
        help=(
            "Determines many background processes will be used for segmentation export."
    ...
    parser.add_argument(
        ...
        default=1,
        help=(
            "Set to 0 to disable test time data "
    ...
    parser.add_argument(
        ...
        required=False,
        help=(
            "Predictions are done with mixed precision by default. This improves speed"
            " and reduces the required vram. If you want to disable mixed precision you"
            " can set this flag. Note that yhis is not recommended (mixed precision is"
            " ~2x faster!)"
        ),
    )
