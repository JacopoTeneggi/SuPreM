...
class MiT_encoder(nn.Module):
    ...
    def __init__(
        ...
        self.patch_embed1 = PatchEmbed(
            ...
            activation_cfg=activation_cfg,
            weight_std=weight_std,
            img_size=[img_size[0] // 1, img_size[1] // 2, img_size[2] // 2],
            patch_size=[2, 2, 2],
            in_chans=32,
        ...
        self.pos_embed4 = nn.Parameter(
            torch.zeros(1, self.patch_embed4.num_patches, embed_dims[3])
        )
...
# tiny
def model_tiny(
    norm_cfg="BN", activation_cfg="ReLU", weight_std=False, in_chans=1, **kwargs
):
    model = MiT_encoder(
        norm_cfg=norm_cfg,
        activation_cfg=activation_cfg,
