...
def main():
    ...
    parser.add_argument(
        "--input_file1", required=True, help="Path to the original train list file"
    )
    parser.add_argument(
        "--input_file2", required=True, help="Path to the original test list file"
    )
    parser.add_argument(
        "--output_dir",
        required=True,
        help="Directory to save the files for cross validation",
    )
