...
def main(args):
    ...
    for pid in error_id_list:
        source_path = os.path.join(
            args.source_datapath, pid, "segmentations", args.class_name + ".nii.gz"
        )
        destination_path = os.path.join(
            args.destination_datapath, pid, "segmentations", args.class_name + ".nii.gz"
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--source_datapath",
        dest="source_datapath",
        type=str,
        default="/Volumes/T9/HGFC_inference_separate_data",
        help="the directory of the AbdomenAtlas dataset",
    )
    parser.add_argument(
        "--destination_datapath",
        dest="destination_datapath",
        type=str,
        default="/Volumes/T9/AbdomenAtlasPro",
        help="the directory of the AbdomenAtlas dataset",
    )
    parser.add_argument(
        "-o",
        dest="csvpath",
        type=str,
        default="error_analysis/aorta.csv",
